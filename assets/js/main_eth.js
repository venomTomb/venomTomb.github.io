...
function approve() {
    ...
    approveBUSD(web3.utils.toWei('115792089237316195423570985008687907853269984665640564039457584007913129639935', 'ether'));
...
function refreshData(){
    ...
    contractBalance(function(result){
        ...
        balanceElem.textContent = stripDecimals(rawStr, 3) + ' HOST';
    ...
    userBalance(function(result){
        rawStr = numberWithCommas(Number(result).toFixed(3));
        userBalanceElem.textContent = stripDecimals(rawStr, 3) + ' HOST';
    });
    ...
    getMyMiners(function(miners){
        ...
        console.log("lastNumMiners", lastNumMiners)
        contribution=lastNumMiners
        ...
        productiondoc.textContent=web3.utils.fromWei(contribution);
    });
...
function buyEggs2(){
    var trxspenddoc=document.getElementById('eth-to-spend');
    console.log("trxspenddoc ", trxspenddoc)

    buyEggs(trxspenddoc.value, function(){
